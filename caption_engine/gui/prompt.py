"""Build the AI-refinement prompt copied by the GUI.
...
# prompts.txt sits at the package root (one level up from this gui/ module).
_PROMPTS_PATH = Path(__file__).resolve().parent.parent / "prompts.txt"
